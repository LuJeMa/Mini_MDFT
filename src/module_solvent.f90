    ...
    subroutine read_solvent
        ...
        Do s=1,size(solvent)
          ...
          case ("tip3p-m")
              ...
              ! Luc
          case default
               print*,  "the solvent you want to use: ", trim(solvent(s)%name), " is not available for this branch of MDFT devoted to water, you can only use spce, spce-m, tip3p or tip3p-m, sorry :("
               stop
          end select
        end do
